...
?>
<?php 
	$dir = opendir(''.JPATH_BASE.'/images/vakansii/'.$item_id.'');
	$count_photo = 0;
...
<?php if($count_photo > 0) { ?>
	<div class="mod_news_img">
		...
		<?php echo JHtml::_('content.prepare', '{gallery preview-width=100 preview-height=80}vakansii/'.$item_id.'{/gallery}'); ?>
	</div>
<?php } else { ?>
	<?php if($img == '/images/vakansii/') { ?>
		<div class="mod_news_img">
			<a href="<?php echo $item->link ?>" title="<?php echo $item->title ?>"><span class="podlozhka"></span></a>
