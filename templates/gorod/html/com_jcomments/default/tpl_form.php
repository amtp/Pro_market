...
<?php class jtt_tpl_form extends JoomlaTuneTemplate
{
	function render() 
	{
...
<div class="input_comment">
	<input id="comments-form-name" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" placeholder="Ваше имя" />
</div>
<?php
		}
...
<div class="captcha_comment">
	...
	<div class="captcha_refresh">	
		<i class="fa fa-refresh"></i> <span class="captcha" onclick="jcomments.clear('captcha');">обновить изображение</span>
	</div>
	<div class="captcha_input">	
		<input class="captcha" id="comments-form-captcha" type="text" name="captcha_refid" value="" size="8" tabindex="6" placeholder="Введите код с картинки" />
	</div>
	</div>
...
<div id="comments-form-buttons">
	<div class="btn" id="comments-form-send"><a href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><i class="fa fa-comments"></i> <span><?php echo JText::_('FORM_SEND'); ?></span></a></div>
