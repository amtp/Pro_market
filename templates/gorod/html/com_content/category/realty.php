...
<div class="auto catalg_items <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
    <div class="add_button mini_menu">
        <span class="mobile" style="margin-bottom: 10px">
    <?php echo JHtml::_('content.prepare', '{loadposition addlink,none}'); ?>
    </span>
    </div>
	...
	<?php endif; ?>
<div class="add_button mini_menu">
	<?php echo JHtml::_('content.prepare', '{loadposition home_realty,none}'); ?>
</div>	
...
<?php echo JHtml::_('content.prepare', '{loadposition reklama_realty,none}'); ?>
	<?php
