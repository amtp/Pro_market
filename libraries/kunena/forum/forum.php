...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2018-10-14' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2018-10-14';
		self::$version_name  = ('Rhea' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Rhea';
	}
