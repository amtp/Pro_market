...
class Document
{
	...
	public function addScriptOptions($key, $options, $merge = true,$isarr=false)
	{
    ...
    public function getScriptOptionsCount($key = null)
    {
        if ($key)
        {
            return (empty($this->scriptOptions[$key])) ? 0 : count($this->scriptOptions[$key]);
        }
        else
        {
            return count($this->scriptOptions);
        }
    }
	/**
