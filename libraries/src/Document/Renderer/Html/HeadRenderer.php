...
class HeadRenderer extends DocumentRenderer
{
	...
	public function fetchHead($document)
	{
      ...
      //  $rname_city     = \Joomla\CMS\Mdata\MdataHelper::to_prepositional($cityname);
		...
		//$buffer .= $tab . '<title>'.htmlspecialchars($document->getTitle(), ENT_COMPAT, 'UTF-8').' '.$dpdsz.' '.$rname_city .'</title>' . $lnEnd;
		...
		{
			$buffer .= $tab . '<script type="application/json" class="bigcatalog-516-options all">';
