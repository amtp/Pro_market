...
class ModAddToMenu
{
	...
	public function render()
	{
		...
		RL_Document::script('addtomenu/script.min.js', '6.4.1');
		RL_Document::stylesheet('addtomenu/style.min.css', '6.4.1');
				...
				if (isset($element->type))
				{
					switch ($element->type)
					{
						case 'radio':
							...
							$values       = isset($element->values->value) ? $element->values->value : $element->values;
