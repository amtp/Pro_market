...
?>
	<ul class="rsform_leftnav" id="rsform_firstleftnav">
		...
		<li><a href="javascript: void(0);" onclick="displayTemplate('2425');return false;" id="rsfpc2425"><span class="rsficon rsficon-image"></span><span class="inner-text"><?php echo JText::_('RSFP_COMP_GALLERY'); ?></span></a></li>
