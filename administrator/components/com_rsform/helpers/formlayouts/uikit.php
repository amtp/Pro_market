...
class RSFormProFormLayoutUIkit extends RSFormProFormLayout
{
    ...
    {
        return '<button type="button" class="rsform-submit-button rsform-thankyou-button uk-button uk-button-primary" name="continue" onclick="'.$goto.'">'.JText::_('Продолжить').'</button>';
    }
}