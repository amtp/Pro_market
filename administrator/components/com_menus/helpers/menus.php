...
class MenusHelper
{
	 ...
	 * @since   1.6
	 */
	public static function getMenuLinks($menuType = null, $parentId = 0, $mode = 0, $published = array(), $languages = array(), $clientId = 0, $ismobile = 0)
	{
		$db = JFactory::getDbo();
		$query = $db->getQuery(true)
		...
		$query->where('a.is_mobile = ' . (int) $ismobile);
