...
class RsformModelDirectory extends JModelLegacy
{
    ...
    public function getReplacements($user_id)
    {
        ...
        $replace = array('{global:sitename}', '{global:siteurl}', '{global:userid}', '{global:username}', '{global:usercompany}', '{global:email}', '{global:useremail}', '{global:fullname}', '{global:mailfrom}', '{global:fromname}');
        $with = array($sitename, $siteurl, $user->id, $user->username, $user->company, $user->email, $user->email, $user->name, $mailfrom, $fromname);
