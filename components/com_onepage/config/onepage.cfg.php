...
*/
 ...
 $reuse_order_statuses = array('P','U');
$opc_async = false; 
    $use_free_text = false; 
...
$email_after = false;
      $opc_link_type = 0;
       $business_fields = array();  $custom_rendering_fields = array();  $per_order_rendering = array('customer_note','tos');  $opc_ajax_fields = array('address_1');  $admin_shopper_fields = array();  $render_as_hidden = array();  $render_in_third_address = array();  $html5_fields = array();  $html5_fields_extra = array();  $html5_placeholder = array();  $html5_validation_error = array();  $shipping_obligatory_fields = array();  $business_obligatory_fields = array(); $op_disable_shipping = false;
 ...
 $opc_usmode = false;  $full_tos_logged = false;  $tos_scrollable = true;  $full_tos_unlogged = false;  $tos_logged = true;  $tos_unlogged = true;  $opc_email_in_bt = false;  $double_email = false;  $coupon_price_display = "salesPriceCoupon";
...
$cut_login = false;
	  ...
	  $selected_template = OPCmini::getSelectedTemplate('gorod', ''); 
