...
<ul id="tab_selector">
 <li  id="op_login_btn" ><?php echo OPCLang::_('COM_VIRTUEMART_LOGIN'); ?></li>
 <li  id="op_register_btn" class="active"  ><?php echo OPCLang::_('COM_VIRTUEMART_REGISTER') ?></li>
</ul>
			...
			<div class="controls">
				<div class="input formField2">
                   ...
                   <input type="text" id="username_login" name="username_login" class="inputbox" size="20" autocomplete="off"  />
                     <div class="clear"></div>
                    <a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>" class="remind" ><?php echo JText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_USERNAME'); ?></a>
				</div>
			</div>
		...
		<div class="width100 remember">
            ...
            <label style="float:left; margin-left:10px;" class="control-label"  for="remember_login"><?php echo $remember_me = VmConfig::isJ15()? OPCLang::_('Remember me') : OPCLang::_('JGLOBAL_REMEMBER_ME'); ?></label>
             <div class="clear"></div>
         	  <?php else : ?>
...
<?php if ($no_shipto != '1') { ?>
	<div class="width50 floatleft">
		...
		<div class="op_shipto_content2">
                <input type="checkbox" id="sachone"  name="sa" value="adresaina"  autocomplete="off"  />
                <label for="sachone" id="sachoneL"><?php echo OPCLang::_('COM_VIRTUEMART_USER_FORM_ADD_SHIPTO_LBL');  ?></label>
