...
<fieldset>
 ...
 <br style="clear: both;"/>
 <input class="styled" name="regtypesel"  type="radio" checked="checked" id="op_register_btn" onclick="javascript: return t_hideFx('logintab');" style="border: none;" /><label for="op_register_btn" class="radio"><?php echo OPCLang::_('COM_VIRTUEMART_REGISTER'); ?></label>
</fieldset>
</div>
	...
	<div>	<label for="remember_login"><?php echo $remember_me = VmConfig::isJ15()? OPCLang::_('Remember me') : OPCLang::_('JGLOBAL_REMEMBER_ME'); ?></label></div>
	<div>
...
?>
	...
	if ($language_tag == "nl-NL") {echo $italian_checkbox;}
	?>
</div>
