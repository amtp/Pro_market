...
*/
	 ...
	 
	{
		...
		echo '<div style="width:100%;" class="all_fields">';
	   	...
	   	foreach( $rowFields['fields'] as $field) {
			...
			if( $field['type'] == 'delimiter')
			{
	   		...
	   		if (( $field['name'] == 'username' && VM_REGISTRATION_TYPE == 'OPTIONAL_REGISTRATION' ) || (( $field['name'] == 'opc_password' && VM_REGISTRATION_TYPE == 'OPTIONAL_REGISTRATION' && (!empty($op_usernameisemail)) ))) {
				echo '<div class="field_wrapper"><div class="wr2"><div class="formLabel inputregister_account">
			...
			echo '<div class="field_wrapper"><div class="vr2">'; 
	   		if( $field['type'] == 'delimiter') {
...
';
			...
			echo '>';
	        echo '<label for="'.$field['name'].'_field">'.$field['title']; 
