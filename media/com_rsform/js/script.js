...
RSFormPro.showThankYouPopup = function (thankYouContainer){
	...
	document.body.innerHTML += '<div class="rsfp_thankyou_popup_outer" id="rsfp_thankyou_popup_outer"  onclick="RSFormPro.accessLink(event,\''+gotoUrl+'\')"><div class="rsfp_thankyou_popup_inner" id="rsfp_thankyou_popup_inner"><div class="rsfp_thankou_popup_close_btn">&times;</div>'+content+'</div></div>';
